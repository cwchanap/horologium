...
class ResourceRegistry {
  static final List<Resource> availableResources = [
    Resource(
      ...
      name: 'Gold',
      value: 1,
      category: ResourceCategory.rawMaterials,
    ),
    Resource(
    ...
    Resource(
      ...
      name: 'Wheat',
      value: 1,
      category: ResourceCategory.foodResources,
    ),
    Resource(
    ...
    Resource(
      ...
      name: 'Flour',
      value: 5,
      category: ResourceCategory.stapleGrains,
    ),
    Resource(
      type: ResourceType.cornmeal,
      name: 'Cornmeal',
      value: 4,
      category: ResourceCategory.stapleGrains,
    ),
    Resource(
      type: ResourceType.polishedRice,
      name: 'Polished Rice',
      value: 2,
      category: ResourceCategory.stapleGrains,
    ),
    Resource(
      type: ResourceType.maltedBarley,
      name: 'Malted Barley',
      value: 2,
      category: ResourceCategory.stapleGrains,
    ),
